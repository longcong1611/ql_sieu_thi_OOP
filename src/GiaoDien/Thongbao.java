 ...
 * @author ngotr
 */
public class Thongbao extends JDialog {
    ...
    public Thongbao(String content, int type) {
    ...
    final ImageIcon iconError = new ImageIcon("Images/cancel.png");
    final ImageIcon iconSuccess = new ImageIcon("Images/check.png");
    final ImageIcon iconInfo = new ImageIcon("Images/info.png");
    final ImageIcon iconWarning = new ImageIcon("Images/warning.png");
    ...
    private void addControls() {
        ...
        lblClose = new JLabel(new ImageIcon("Images/remove.png"));
