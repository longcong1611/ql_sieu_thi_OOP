...
public class PhieuNhapJPanel extends javax.swing.JPanel {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (selectedRowPN >= 0) {
        ...
        } else if (selectedRowCTPN >= 0) {
            // Xóa chi tiết phiếu nhập (chức năng cũ)
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng chọn một phiếu nhập hoặc chi tiết phiếu nhập để xóa!", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
